...
public class shootingGame extends JFrame {
	...
	private Image loadingScreen = new ImageIcon("src/img/loadingScreen.jpg").getImage();//이미지 바꿀것
	private Image gameScreen = new ImageIcon("src/img/game_screen.png").getImage();//이미지 바꿀것
